    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="section-title">
                  <h2>
                    ...
                    <p>Here is the details of my family.</p>
                </div>
              ...
              <tr>
                ...
                <div class="col-md-12 text-center">
                    <a class="btn btn-primary" href="{{ env('APP_URL') }}/customers/edit/{{ $id }}">
                        Edit
                    </a>
                </div>
            </div>
        ...
        {{-- <div class="container">
            <div class="row">
                ...
                {{"Name: " . $customers[0]->name}}<br>
                {{"Age: " . $customers[0]->age}}<br>
                {{"Gender: " . $customers[0]->gender}}<br>
